        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">ФИАС коды</li>
                </ol>
                <hr>
                <div>
                    <table id="fias">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var table = $('#fias').DataTable({
                ...
                "ajax": {
                    type: "POST",
                    url: "ajax/manual/settings.fias.php",
                },
                columns: [
                    ...
                    {data: null,
                        "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
                            $(nTd).html("<button id='" + oData.plc_id + "' class='btn btn-primary btn fias_id'><i class='fas fa-pencil-alt'></i>...</button>");
                        }
                    }
